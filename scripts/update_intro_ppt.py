...
shape_updates = {
    ...
    8: {
        ...
        3: [
            ...
            "已移除旧版 valid 与 depth_edge 两个附加通道，避免增加弱监督噪声和旧 checkpoint 形状依赖。",
    ...
    9: {
        ...
        1: [
            ...
            "④ 缓存版本：新增 LIDAR_CACHE_VERSION=k_projection_7ch_v1，旧 9ch 或旧投影缓存会自动失效并重算。",
    ...
    25: {
        ...
        3: [
            ...
            "当前修复：训练和测试统一使用真实 K 投影，移除 valid/edge 两个弱通道，加入缓存版本，保留 z_d 作为 FiLM 绝对尺度。",
